                        ...
                        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    Terakhir diperbarui: 23 Mei 2023 <br> Selamat datang di SafeSpeak. Harap baca dengan seksama persyaratan layanan ini sebelum menggunakan situs web kami. <br><br> Dengan mengakses dan menggunakan SafeSpeak, Anda menyetujui dan terikat oleh persyaratan yang tercantum di bawah ini. Jika Anda tidak setuju dengan persyaratan ini, mohon untuk tidak melanjutkan penggunaan situs web kami.<br><br>
                                        1. Kebijakan Penggunaan <br>
                                        Anda setuju untuk menggunakan SafeSpeak sesuai dengan semua hukum yang berlaku dan peraturan yang relevan. Anda bertanggung jawab sepenuhnya atas aktivitas yang dilakukan melalui akun Anda, serta konten yang Anda unggah atau bagikan melalui platform kami. Anda tidak diperkenankan untuk: <br><br>
                                        ...
                                        Kami menghargai privasi Anda dan berkomitmen untuk melindungi data pribadi Anda. Dalam penggunaan SafeSpeak, kami akan mengumpulkan, menggunakan, dan melindungi informasi pribadi Anda sesuai dengan Kebijakan Privasi kami yang berlaku. Dengan menggunakan situs web kami, Anda menyetujui pengumpulan, penggunaan, dan penyimpanan data pribadi Anda termasuk data lokasi Anda sebagaimana dijelaskan dalam Kebijakan Privasi kami. <br>
                                        3. Keamanan Akun <br>
                                        ...
                                        SafeSpeak menyediakan platform untuk penggunaan yang nyaman dan aman, namun kami tidak memberikan jaminan atas kelengkapan, keakuratan, atau ketersediaan informasi yang disediakan di situs web kami. Kami tidak bertanggung jawab atas kerugian atau kerusakan yang timbul dari penggunaan atau ketidakmampuan menggunakan SafeSpeak. <br><br>
                                        5. Perubahan dan Pembaruan <br>
                                        SafeSpeak berhak untuk memperbarui, mengubah, atau menghapus persyaratan layanan ini kapan saja tanpa pemberitahuan sebelumnya. Setiap perubahan akan segera berlaku setelah diposting di situs web kami. Penggunaan terus-menerus dari SafeSpeak setelah perubahan tersebut merupakan penerimaan Anda terhadap perubahan tersebut. <br><br>
                                        6. Penyelesaian Sengketa dan Hukum yang Berlaku <br>
                                        Persyaratan layanan ini tunduk pada hukum yang berlaku di negara kami. Jika terjadi sengketa antara Anda dan SafeSpeak, kami akan berupaya menyelesaikan sengketa tersebut melalui negosiasi dan mediasi yang baik dan jujur. <br><br>
                                </div>
